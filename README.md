...
* household_power_consumption.zip - Original source dataset used by R scripts
...
### Inputs
* homedir - directory where the original dataset file, and the script files are located.  Default is the current working directory
